...
namespace Algorithms
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			// Bubble
			Sort<int>.Bubble(Logic.compare, get, assign, 0, dataSet.Length);
			...
			// Selection
			Sort<int>.Selection(Logic.compare, get, assign, 0, dataSet.Length);
			...
			// Insertion
			Sort<int>.Insertion(Logic.compare, get, assign, 0, dataSet.Length);
			...
			// Quick
			Sort<int>.Quick(Logic.compare, get, assign, 0, dataSet.Length);
			Console.Write("Quick: ");
			Console.Write(dataSet[0]);
			for (int i = 1; i < dataSet.Length; i++)
				Console.Write(", " + dataSet[i]);
			...
			// Merge
			Sort<int>.Merge(Logic.compare, get, assign, 0, dataSet.Length);
			Console.Write("Merge: ");
			Console.Write(dataSet[0]);
			for (int i = 1; i < dataSet.Length; i++)
				Console.Write(", " + dataSet[i]);
			...
			// Heap
			Sort<int>.Heap(Logic.compare, get, assign, 0, dataSet.Length);
			Console.Write("Heap: ");
			Console.Write(dataSet[0]);
			for (int i = 1; i < dataSet.Length; i++)
				Console.Write(", " + dataSet[i]);
			...
			// OddEven
			Sort<int>.OddEven(Logic.compare, get, assign, 0, dataSet.Length);
