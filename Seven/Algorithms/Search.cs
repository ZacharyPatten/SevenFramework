...
namespace Seven.Algorithms
{
	...
	public static class Search<T>
	{
		...
		public static int BinarySearch(Get<T> get, int length, T value, Compare<T> compare)
		{
			if (get == null)
				throw new System.ArgumentNullException("get");
			if (compare == null)
				throw new System.ArgumentNullException("compare");
			return BinarySearch(get, 0, length, value, compare);
		}

		private static int BinarySearch(Get<T> get, int index, int length, T value, Compare<T> compare)
		{
			int low = index;
			...
			while (low <= hi)
			{
				...
				switch (compare(get(median), value))
				{
		...
		public static class Graph<Math>
		{
			...
			/// <param name="goal">Predicate for determining if we have reached the goal node.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Astar(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, Cost cost, Goal goal)
			{
			...
			/// <param name="goal">The goal node.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Astar(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, Cost cost, T goal)
			{
			...
			/// <param name="equate">A delegate for checking for equality between two nodes.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Astar(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, Cost cost, T goal, Equate<T> equate)
			{
			...
			/// <param name="goal">Predicate for determining if we have reached the goal node.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Greedy(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, T goal)
			{
			...
			/// <param name="equate">Delegate for checking for equality between two nodes.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Greedy(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, T goal, Equate<T> equate)
			{
			...
			/// <param name="goal">Predicate for determining if we have reached the goal node.</param>
			/// <returns>Stepper of the shortest path or null if no path exists.</returns>
			public static Stepper<T> Greedy(T start, Seven.Structures.Graph<T> graph, Heuristic heuristic, Goal goal)
			{
