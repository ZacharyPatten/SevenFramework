...
//		{
//			if (lowerBound == null) { throw new System.ArgumentNullException("lowerBound"); }
//			if (upperBound == null) { throw new System.ArgumentNullException("upperBound"); }
//			if (Compute<T>.Compare(lowerBound, upperBound) == Comparison.Greater) { throw new System.ArgumentException("lowerBound > upperBound"); }
...
//		{
//			Code.NotNull("value", (object)value);
...
//		{
//			Code.NotNull("value", value);
//			Code.IsTrue("value", Overlaps(value));    // Intersect makes no sense unless there is an overlap
...
//		{
//			Code.NotNull("value", value);
//			Code.IsTrue("value", IsContiguousWith(value));    // Union makes no sense unless there is a contiguous border
...
//		{
//			Code.NotNull("value", value);
//			Code.IsFalse("value", Contains(value));
...
//		{
//			Code.NotNull("position", (object)position);
//			Code.IsTrue("position", Contains(position));
...
//		{
//			Code.IsTrue("startIndex", startIndex >= 0);
//			Code.NotNull("values", values);
//			Code.NotEmpty("values", values);
...
//			Code.NotNull("values", values);
//			Code.NotEmpty("values", values);
//			Code.IsTrue("range", (values.Length == (range.UpperBound - range.LowerBound)));
...
//		{
//			Code.NotNull("from", (object)from);
//			Code.NotNull("to", (object)to);
...
//			Code.NotNull("from", (object)from);
//			Code.NotNull("to", (object)to);
//			Code.IsTrue("from", from.CompareTo(to) <= 0);
...
//		{
//			Code.NotNull("ranges", ranges);
//			Code.NotNull("item", (object)range);
