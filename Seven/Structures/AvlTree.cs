...
namespace Seven.Structures
{
	...
	public static class AvlTree
	{
		...
		#endregion
		#region public static bool TryRemove<T, Key>(this AvlTree<T> structure, Key removal, Compare<T, Key> comparison)
