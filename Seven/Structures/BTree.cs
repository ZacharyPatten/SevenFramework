...
namespace Seven.Structures
{
		...
		Structure.Auditable<T>
	{
		...
		#endregion
		#region T Get<Key>(Key get, Compare<T, Key> compare);
		...
		#endregion
		#region void Remove<Key>(Key removal, Compare<T, Key> compare);
	...
	{
		// extensions
		#region public static bool TryGet<T, Key>(this BTree<T> structure, Key get, Compare<T, Key> comparison, out T item)
		...
		#endregion
		#region public static bool TryRemove<T, Key>(this BTree<T> structure, Key removal, Compare<T, Key> comparison)
	...
	public class BTreeLinkedArray<T> : BTree<T>
	{
		...
		#endregion
		// constructors
		#region BTree_LinkedArray(Compare<T> compare, int node_size)
