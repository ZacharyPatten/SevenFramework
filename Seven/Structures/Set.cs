...
namespace Seven.Structures
{
		...
		Structure.Hashing<T>
	{
		...
		#endregion
		// constructors
		#region public SetHashList()
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public SetHashList() : this(Seven.Equate.Default, Seven.Hash.Default) { }
		#endregion
		#region public SetHashList(int expectedCount)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public SetHashList(int expectedCount) : this(Seven.Equate.Default, Seven.Hash.Default, expectedCount) { }
		#endregion
		#region public Set_Hash(Equate<T> equate, Hash<T> hash)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public SetHashList(Equate<T> equate, Hash<T> hash) : this(Seven.Equate.Default, Seven.Hash.Default, 0) { }
		#endregion
		#region public SetHashList(Equate<T> equate, Hash<T> hash, int expectedCount)
		/// <summary>Constructs a new hash table instance.</summary>
		...
		#endregion
		#region private SetHashList(SetHashList<T> setHashList)
		...
		Structure.Hashing<T>
	{
		...
		public SetHashArray() : this(Seven.Equate.Default, Seven.Hash.Default) { }
		#endregion
		#region public SetHashArray(int expectedCount)
		public SetHashArray(int expectedCount) : this(Seven.Equate.Default, Seven.Hash.Default) { }
		#endregion
		#region public Set_Hash(Equate<T> equate, Hash<T> hash)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		...
		where STRUCTURE : class, Structure<T>, Structure.Addable<T>, Structure.Removable<T>, Structure.Auditable<T>
	{
		...
		private Construct<T> _constructor;
		private Equate<T> _equate;
		private Hash<T> _hash;
		...
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set(Construct<T> constructor) : this(constructor, Seven.Equate.Default, Seven.Hash.Default) { }
		#endregion
		#region public Set(Construct<T> constructor, int expectedCount)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set(Construct<T> constructor, int expectedCount) : this(constructor, Seven.Equate.Default, Seven.Hash.Default, expectedCount) { }
		#endregion
		#region public Set(Construct<T> constructor, Equate<T> equate, Hash<T> hash)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set(Construct<T> constructor, Equate<T> equate, Hash<T> hash) : this(constructor, Seven.Equate.Default, Seven.Hash.Default, 0) { }
		#endregion
		#region public Set(Construct<T> constructor, Equate<T> equate, Hash<T> hash, int expectedCount)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(stepper).</remarks>
		public Set(Construct<T> constructor, Equate<T> equate, Hash<T> hash, int expectedCount)
		{
			if (expectedCount > 0)
			{
				int prime = (int)(expectedCount * (1 / _maxLoadFactor));
			...
			{
				this._table = new STRUCTURE[Seven.Hash.TableSizes[0]];
			}
			this._equate = equate;
			this._hash = hash;
			this._count = 0;
		...
		{
			this._constructor = set_generic._constructor;
		...
		public void Clear()
		{
			_table = new STRUCTURE[Seven.Hash.TableSizes[0]];
			_count = 0;
		}
		#endregion
		#region public void Stepper(Step<T> function)
